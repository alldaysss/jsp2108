...
public class UpLoad1OkCommand implements StudyInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 서버에 저장될 파일의 실제 ContextPath경로의 Root폴더? getRealPath()  ==> application객체에 포함되어 있다.
		...
		String filesystemName = multipartRequest.getFilesystemName("fName"); // 실제 서버에 저장되는 파일 명
		
		System.out.println("서버에 저장된 실제경로 : " + application.getRealPath("/"));
