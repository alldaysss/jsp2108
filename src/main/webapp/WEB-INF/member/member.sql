...
create table member (
	...
	pwd varchar(50) not null, /* 비밀번호(입력시 9자로 제한처리할것) 실무에서는 100개도 받는다.*/
	...
	userDel char(2) default 'NO', /* 회원 탈퇴 신청 여부(OK:탈퇴신청한회원, NO:현재가입중인 회원) */
	...
	lastDate datetime default now(), /* 최초 가입일 */
