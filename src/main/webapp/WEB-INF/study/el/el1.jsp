...
<div class="container">
		...
		<p>
			<b>용도 : 사용자가 값(변수/객체/수식)을 전송후에 담아줄(저장할) 용도로 사용한다.</b>
	...
	<hr/>
<%
	String atom = "Seoul"; // String atom = request.getParameter("atom"); 와 같은 용도로 사용중...
	String name = "홍길동";
	int su1 = 100, su2 = 200;
%>
	<p>앞에 저장된 내용을 스크립틀릿을 이용한 출력?</p>
	atom = <%=atom%><br/>
	name= <%=name%> <br/>
	su1 = <%=su1 %> <br/>
	su2 =  <%=su2 %> <br/>
