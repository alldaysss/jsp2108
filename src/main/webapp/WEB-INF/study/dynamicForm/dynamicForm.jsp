...
<!-- 본문 내용 모두 실행하고 스크립트 실행 -->
<script>
	var cnt = 1;
	/* 동적폼은 cnt를 무조건 밖으로 빼줘야한다. */
	...
	function textBoxAppend() {
		...
		textBox += '<input type="button" value="삭제" onclick="deleteBox('+cnt+')" class="btn btn-outline-secondary form-control ml-2" style="width:10%"/>';
		textBox += '</div>';
