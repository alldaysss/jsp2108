...
<script>
	...
	function fileAppend() {
		...
		fileIn += '<input type="file" name="fName'+cnt+'" id="fName'+cnt+'" class="form-contorl-file border" accept=".jpg,.gif,.png,.zip,.ppt,.pptx,.hwp"/>';
	...
	<div class="container">
		<form name="myform" method="post" action="${ctp}/pdsInputOk.pds" enctype="multipart/form-data">
			...
			<div class="form-group">
				<input type="button" value="파일 추가" onclick="fileAppend()"/><br/>
				<input type="file" name="fName1" id="fName1" class="form-contorl-file border" accept=".jpg,.gif,.png,.zip,.ppt,.pptx,.hwp"/>
			</div>
			...
			<div class="form-group">
				...
				<textarea rows="" name="content" id="content" class="form-control"></textarea>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<input type="button" value="자료올리기" onclick="fCheck()" class="btn btn-secondary"/>
				<input type="reset" value="다시쓰기"class="btn btn-secondary"/>
				<input type="button" value="돌아가기" onclick="javascript:location.href='${ctp}/pdsList.pds';" class="btn btn-secondary"/>
			</div>
